...
namespace DoAnLapTrinhQuanLy.GuiLayer
{
    public partial class FormBaoCaoKho : Form
    {
        ...
        private void BtnXemBaoCao_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Vui lòng ch?n hàng hóa d? xem th? kho.", "Thông báo");
                return;
            }
            ...
            try
            {
                // 1. Calculate Opening Stock (T?n Ð?u)
                string sqlTonDau = @"
                    SELECT 
        ...
        private void Pd_PrintPage(object sender, PrintPageEventArgs e)
        {
            ...
            string dateRange = $"T? ngày {dtpTuNgay.Value:dd/MM/yyyy} d?n ngày {dtpDenNgay.Value:dd/MM/yyyy}";
            ...
            string[] headers = { "Ngày", "S? Phi?u", "Di?n Gi?i", "Nh?p", "Xu?t", "T?n" };
